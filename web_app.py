"""
Lab 11 — Web UI để tương tác với hệ thống tấn công và phòng thủ.
...
<head>
    ...
    <title>VinBank Security Lab — Interactive Demo</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .log-type.blocked { background: #ef4444; color: white; }
        .log-type.passed { background: #22c55e; color: white; }
    ...
    <div class="container">
        ...
        <div class="panel">
            <h2>
                ...
                <span class="badge badge-unsafe">NO GUARDRAILS</span>
            </h2>
            ...
            <div class="attack-buttons">
                ...
                <button class="attack-btn" onclick="sendAttack('unsafe', 2)">🔴 Translate prompt</button>
                <button class="attack-btn" onclick="sendAttack('unsafe', 3)">🔴 Story credentials</button>
                <button class="attack-btn" onclick="sendAttack('unsafe', 4)">🔴 Confirm password</button>
                <button class="attack-btn" onclick="sendAttack('unsafe', 5)">🔴 Multi-step</button>
            </div>
            <div class="stats">
                <div class="stat-card">
                    <div class="value" id="unsafe-total">0</div>
                    <div class="label">Tin nhắn</div>
                </div>
                <div class="stat-card">
                    <div class="value" id="unsafe-leaked" style="color:#ef4444">0</div>
                    <div class="label">Lộ secret</div>
                </div>
                <div class="stat-card">
                    <div class="value" id="unsafe-rate">0%</div>
                    <div class="label">Tỷ lệ lộ</div>
                </div>
            </div>
        </div>
        ...
        <div class="panel">
            <h2>
                <span>🛡️ Protected Agent</span>
                <span class="badge badge-protected">GUARDRAILS ON</span>
            </h2>
            ...
            <div class="attack-buttons">
                ...
                <button class="attack-btn" onclick="sendAttack('protected', 2)">🟢 Translate prompt</button>
                <button class="attack-btn" onclick="sendAttack('protected', 3)">🟢 Story credentials</button>
                <button class="attack-btn" onclick="sendAttack('protected', 4)">🟢 Confirm password</button>
                <button class="attack-btn" onclick="sendAttack('protected', 5)">🟢 Multi-step</button>
            </div>
            <div class="stats">
                <div class="stat-card">
                    <div class="value" id="protected-total">0</div>
                    <div class="label">Tin nhắn</div>
                </div>
                <div class="stat-card">
                    <div class="value" id="protected-blocked" style="color:#22c55e">0</div>
                    <div class="label">Bị chặn</div>
                </div>
                <div class="stat-card">
                    <div class="value" id="protected-rate">0%</div>
                    <div class="label">Tỷ lệ chặn</div>
                </div>
            </div>
        </div>
        ...
        <div class="panel">
            <h2>
                <span>🔒 Guards Agent</span>
                <span class="badge badge-guards">STRONG GUARDRAILS</span>
            </h2>
            ...
            <div class="attack-buttons">
                ...
                <button class="attack-btn" onclick="sendAttack('guards', 2)">🟣 Translate prompt</button>
                <button class="attack-btn" onclick="sendAttack('guards', 3)">🟣 Story credentials</button>
                <button class="attack-btn" onclick="sendAttack('guards', 4)">🟣 Confirm password</button>
                <button class="attack-btn" onclick="sendAttack('guards', 5)">🟣 Multi-step</button>
            </div>
            <div class="stats">
                <div class="stat-card">
                    <div class="value" id="guards-total">0</div>
                    <div class="label">Tin nhắn</div>
                </div>
                <div class="stat-card">
                    <div class="value" id="guards-blocked" style="color:#a855f7">0</div>
                    <div class="label">Bị chặn</div>
                </div>
                <div class="stat-card">
                    <div class="value" id="guards-rate">0%</div>
                    <div class="label">Tỷ lệ chặn</div>
                </div>
            </div>
        </div>
...
def chat():
    ...
    try:
        ...
        return jsonify({"error": f"Không thể khởi tạo agent: {str(e)}"})
    ...
    return jsonify({"error": "Unknown agent type"})
...
if __name__ == "__main__":
    print("=" * 60)
    print("VinBank Security Lab — Web UI")
    print("=" * 60)
    ...
    try:
        init_agents()
        print("✓ Agents đã sẵn sàng")
    except Exception as e:
        print(f"⚠ Lỗi khởi tạo agents: {e}")
        print("  Hãy chắc chắn đã thêm GOOGLE_API_KEY vào .env")
